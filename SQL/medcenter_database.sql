...
-- -----------------------------------------------------
-- Table `medcenter_database`.`treatment_types`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `medcenter_database`.`treatment_types` (
...
CREATE TABLE IF NOT EXISTS `medcenter_database`.`doctors` (
  ...
  INDEX `fk_doctors_services_types1_idx` (`treatment_type_id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_doctors_addresses1`
    ...
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
  CONSTRAINT `fk_doctors_services_types1`
    FOREIGN KEY (`treatment_type_id`)
    REFERENCES `medcenter_database`.`treatment_types` (`treatment_type_id`)
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS `medcenter_database`.`treatments` (
  ...
  INDEX `fk_services_services_types1_idx` (`treatment_type_id` ASC) VISIBLE,
  CONSTRAINT `fk_services_services_types1`
    FOREIGN KEY (`treatment_type_id`)
    REFERENCES `medcenter_database`.`treatment_types` (`treatment_type_id`)
    ON DELETE NO ACTION
    ON UPDATE CASCADE)
